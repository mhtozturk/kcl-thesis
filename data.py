    ...
    def process_mda(self, pages: list) -> list:
        ...
        for page in pages:
            ...
            paragraphs = [paragraph for paragraph in page_soup.find_all(lambda tag: tag.name == 'div' or tag.name == 'p')
                          if Data.PATTERN.search(paragraph.get_text(strip = True).lower())]
            ...
            for paragraph in paragraphs:
                ...
                if paragraph.name == 'div':
                    ...
                    if italic:
                        ...
                        # normalizing text
                        normalized.append(unicodedata.normalize('NFKC', paragraph.get_text(strip = True).lower()).replace('  ', ' '))
                else:
                    if 'italic' in tag.get('style', ''):
                        continue
                    else:
